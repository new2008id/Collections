...
class CarListTest {
    ...
    @Test
    public void whenElementIsFoundReturnTrue() {
        assertTrue(carList.contains(new Car("brand0", 0)));
    }

    @Test
    public void whenElementIsNotFoundReturnFalse() {
        assertFalse(carList.contains(new Car("Test", 1)));
    }

    @Test
    public void whenElementIsEnteredReturnFalse() {
        assertFalse(carList.contains(null));
    }

    @Test
    public void whenEmptyListThenContainsReturnFalse() {
        carList.clear();
        assertFalse(carList.contains(new Car("Test", 1)));
    }
    ...
    public void addNullElementTest() {
        assertThrows(NullPointerException.class, () -> carList.add(null));
    }
}